                  ...
                  <ul>
                    <li>
                      <div class="featured-image">
                        <a href="property-details.html"><img src="<?php echo base_url();?>/assets/images/property/property1.jpg" alt=""></a>
                      </div>
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 logo-block">
              <div class="logo-image">
                <a href="index.html"><img src="<?php echo base_url();?>/assets/images/logo/logo-footer.png" alt="CitiLights"></a>
              </div>
            </div>
          </div>          
        </div>
